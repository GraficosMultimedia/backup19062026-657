...
<title>Precios de impresión · Colibrí Print</title>
...
<div class="cp-hero">
    <div>
        <h1>Precios de impresión</h1>
        <p>Administra tamaños, materiales, acabados y las combinaciones de precios que verá el cliente.</p>
    </div>
    <div class="cp-admin-nav">
        <a class="cp-btn cp-btn-soft" href="recepcion_impresiones.php">Recepción</a>
...
<tr>
    ...
    <td>
        <form method="post" action="price_delete.php" onsubmit="return confirm('¿Desactivar esta tarifa?')">
            <input type="hidden" name="csrf" value="<?= cp_e(cp_csrf()) ?>">
